        ...
        <div className="loginPage">
            ...
            <div className="landingText">
                ...
                <div className="buttonsDiv">
                    <Button className="Btn" onClick={()=>navigate('/login')} variant="outline-warning" id="loginButton">Login</Button>
                    <Button className="Btn" onClick={()=>navigate('/register')} variant= "outline-warning" id="registerButton">Registrati</Button>
                </div>
            </div>
        </div>
    )
